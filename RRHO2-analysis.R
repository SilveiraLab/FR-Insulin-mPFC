...
# 
# The input filenames below correspond to the Male and P90 conditions.
# Adjust to other conditions for the files in the above GEO page as appropriate. 
#
# -----------------------------

insulin_data <- read_de_data(
  "P90_Males_INS_comparison_mPFC.txt"
)

fr_data <- read_de_data(
  "P90_Males_FR_comparison_mPFC.txt"
)

fr_insulin_data <- read_de_data(
  "P90_Males_FRINS_comparison_mPFC.txt"
)
